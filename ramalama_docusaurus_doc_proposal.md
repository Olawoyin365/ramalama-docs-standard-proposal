...
This document establishes formatting and style standards for RamaLama documentation to ensure consistency, readability, and maintainability across all documentation pages to ensure all editors formatting style is coherent across all pages.. It synthesizes best practices from:
...
These standards is proposed to:
...
Every documentation page is proposed to follow this structure abiding by the Docusaurus formatting standard which is what RamaLama docs are built with:
...
## Contributing to This Formatting Style Proposal

### How to Propose Changes

This formatting standard is a susceptible to improvement. To propose changes:
...
4. **Submit a pull request:**
   ...
   - Description: Give more information on the changes you are improving.

### Discussion Process

- All formatting standard changes require community discussion by all contributors
- Changes would be discussed by all contributors and merge upon agreement
